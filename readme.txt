...
cite papers. _THIS FORK ADDS SUPPORT FOR TEXTUAL FOOTNOTES, BESIDES
REFERENCES FROM BIBLIOGRAHIC DATABASES._
...
HTTPS://GITHUB.COM/DIGFISH/PAPERCITE. DOCUMENTATION CAN BE FOUND ON
HTTP://PAPERCITE.READTHEDOCS.ORG/EN/LATEST/.
...
THE DOCUMENTATION LINK). You can see the documentation of the plugin as
installed on my site here.
