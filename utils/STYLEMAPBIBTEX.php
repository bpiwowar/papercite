...
Modified by B. Piwowarski for papercite
...
// Edit values if necessary
			...
			'thesis'		=>	array(array('phdthesis', array("label" => "PhD Thesis")), array('masterthesis', array("label" => "Master Thesis"))),
			'web_article'		=>	FALSE,
			'film'			=>	FALSE,
			'broadcast'		=>	FALSE,
			'music_album'		=>	FALSE,
...
// WEB ARTICLE
		...
		$this->web_article["year"] = 'accessYear';
